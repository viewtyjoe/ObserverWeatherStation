 ...
 * implementation of the interface java.util.Observer. This is necessary so the
 ...
 * @author jlombardo
 */
public class Person extends JFrame implements Observer {
    private String name;
    private JList inbox;
    ...
    /**
     * This method is dicated by the java.util.Observer interface which
     * the Publisher use to notify its subscriber list.
     *
     ...
     */
    @Override
    public void update(Observable publisher, final Object info) {
